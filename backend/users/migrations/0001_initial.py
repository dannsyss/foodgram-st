    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'author'), name='unique_subscriber'), models.CheckConstraint(condition=models.Q(('user', models.F('author')), _negated=True), name='unique_subscriber_himself')],
            },
        ),
    ]
